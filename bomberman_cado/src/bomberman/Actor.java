...
public class Actor {
	...
	public static final int RIGHT1 = 22;
	public static final int UP = 3;
	public static final int UP1 = 33;
	public static final int DOWN = 4;
	public static final int DOWN1 = 44;
	...
	public void drawActor(Graphics2D g2d) {
		...
		case BOMBER:
			...
			g2d.drawImage(img, x, y - 14, null);
			break;
		case MONSTER:
			g2d.drawImage(img, x, y - 4, null);
			break;
		case BOMB:
	...
	public void drawActor1(Graphics g) {
