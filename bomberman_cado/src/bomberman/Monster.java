...
public class Monster extends Actor {
	...
	public void changeOrient(int orient) {
		...
		if (type == Actor.MONSTER) {
			switch (orient) {
			case LEFT:
				img = new ImageIcon(getClass().getResource("/Images/quaivat 2_left.png")).getImage();
				break;
			case RIGHT:
				img = new ImageIcon(getClass().getResource("/Images/quaivat 2_right.png")).getImage();
				break;
			case UP:
				img = new ImageIcon(getClass().getResource("/Images/quaivat 2_up.png")).getImage();
				break;
			case DOWN:
				img = new ImageIcon(getClass().getResource("/Images/quaivat 2_down.png")).getImage();
				break;
			default:
				break;
			}
